...
// Overloaded wait function to perform down operation with timeout
int sem_wait (int id, short unsigned int num, const int timeout)
{
  timespec timer = {timeout, 0};
  struct sembuf op[] = {
    {num, -1, SEM_UNDO}
  };
